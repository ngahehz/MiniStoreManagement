...
namespace MiniStoreManagement.DAO
{
    internal class PromotionDAO
    {
        ...
        {
            string s = $"INSERT INTO promotion VALUES ('{promotion.Id}', '{promotion.Name}','{promotion.Discription}','{promotion.PercentDiscount}','{promotion.StartDate}','{promotion.EndDate}')";
        ...
        {
            string s = $"UPDATE promotion SET ID = '{promotion.Id}', NAME = '{promotion.Name}', DISCRIPTION = '{promotion.Discription}', PERCENT_DISCOUNT = '{promotion.PercentDiscount}',"
